...
* 相关概念：
	* [关于：精准脱碳]({{ < ref "/about/精准脱碳" >}})－－要如何事半功倍？澳恪森的系统创新、（产业链）网络效应、及数据驱动决策３者融合的观点
	* [关于：绿色数字行动]({{ < ref "/about/绿色数字行动" >}})－－要如何借力使力？澳恪森的策略传播、标准创新、（数字创新）网络效应３者集成的行动战略
	* [关于：双碳管服平台]({{ < ref "/about/双碳管服平台" >}})－－要如何营运日常践行？澳恪森的数据驱动决策、标准创新、（平台商业模式）网络效应３者集成的平台设计
	* [关于：数字创新生态]({{ < ref "/about/数字创新生态" >}})－－要如何鱼帮水水帮鱼？澳恪森的生态创新、数字创新、及系统创新的地图工具箱
...
The outcomes will be incorporated, as a use-case, into the Green Digital Action Toolkits, to be released by Oxford Roadmapping's free-to-use [【GDAStandard】project]({{< ref "/project/prj-roadmap_GDAStandard">}}).  It will demonstrate the usefulness of green digital action innovation and standardization for green digital transformation via platform-building. 

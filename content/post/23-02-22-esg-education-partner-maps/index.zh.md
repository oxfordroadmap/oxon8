...
此研究以创新设计「我们可以怎样」(How Might We)思维方法，在 ESG 咨询﹑报告和参与方面产出教育合作路线图。研究及设计方法恪遵设计科学举办设计工作坊，整合了设计思维、文献分析和跨学科专家访谈。
<!--more-->
...
此研究提出了一个概念框架——ESG和碳信息的智能体系，以总结ESG和碳信息的规划丶运营和沟通，以及高层次的组织行动和人才能力体系。此框架明确了企业内ESG操作系统的构建区块，以吸引各种利益相关者进行价值创造协作。### ESG 与碳信息的智能体系

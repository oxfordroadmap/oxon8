...
1. 精准脱碳``[交互可视化产品 prj-VisCEADs]({{< ref "/visualization/prj-VisCEADs" >}})``
2. 使用说明``[交互可视化产品 prj-VisCEADs]({{< ref "/visualization/prj-VisCEADs/html" >}})``
...
澳恪森稍早于2023年释出[「α」版本]({{< ref "/project/prj-VisCEADs0.1" >}})。预计于2024下半年推出``科研产研客制化产品``（订价💵USD 6.8k 或 💴RMB 50k起），2025年推出``脱碳智能助手``生成建议及可视化。

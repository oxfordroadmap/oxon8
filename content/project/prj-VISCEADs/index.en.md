...
Try it by [clicking on here]({{< ref path="/visualization/prj-VisCEADs/index" lang="en" outputFormat="html" >}}) !
...
As shown below, the visualization outcomes are interactive! You can also [click on this for full-screen experience](/en/visualization/prj-VisCEADs/index.en.html).

<iframe class = "info-vis" src="/en/visualization/prj-VisCEADs/index.en.html" width="100%" style="border:none;"></iframe>

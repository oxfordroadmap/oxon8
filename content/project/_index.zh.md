...
澳恪森Oxford Roadmapping专精于<i class="ai ai-pubpeer ai-2x fa-shake"></i>数据科学、<i class="fa fa-recycle ai-2x fa-spin"></i>绿色数字转型、<i class="ai ai-ieee ai-2x fa-flip"></i>技术路线图的结合，提供<i class="fas fa-cog ai-2x fa-spin" / ></i>技术创新、<i class="fas fa-lightbulb ai-2x fa-beat-fade" / ></i>系统创新、以及技术标准化的服务。2023年公司成立后，一共参与或创建4项项目，涵括数据产品原型、科研辅导合作（省级）、及国际标准活动。 

...
(绿色/数字)标准化需要共享创新和建立共识。 透过应用和技术领域相互学习，标准使创新发挥作用。
...
{{< figure src="IEC_ISO_ITU_IEEE.png" title="绿色数字行动标准工作的主要国际组织" width="320px" >}}
{class="object-fit-fill" id="IEC_ISO_ITU_IEEE"}
...
可以说，标准在市场的作用是确任创新的供给和需求的期待，数字或非数字产品，都有面临绿色化低碳化的转型需求及机运。所以，只要你有转型、创新、等业务或研发需求，都应该审视一下是否能加入国际及本地的绿色数字行动，以占先机。
...
请动笔把你想到的绿色化、可持续性、或正向环境、社会、及治理(ESG)影响写下来。

## 1.3 小结：绿色化数字化学习创新

所以若您已在**绿色化**或**数字化**想要交付「具有商业和环境意义的标准」，并同时瞭解全世界**创新**或标准的前沿机遇及空缺，那么和我们一同学习！

若你重心不在标准本身，那么以标准代表及涉及的**技能职缺**、**实践知识**、**设计思维**、**应用领域** 等等，都需要紧抓**技术可行**、**商业可持续**、**用户/买家可欲**的黄金交叉，那么标准正是体现即将应用在社会及市场的新创新，想想5G标准，想想双碳标准，学习标准及标准化意谓着被同行认可的专业深入能力。
...
在此同行学习项目GDAStandard (Green Digital Action Standard)，澳恪森从做中学 (Learning by Doing)，在自身发展创新专利、团体及囯际准活动参与的过程中，展示我们使用的

1. 创新设计思维工具箱（主要来源：ITU, DataPop, 等）
2. 绿色数字行动（标准化）工具箱（主要来源：ITU, IEEE等）
3. 具体产品的开放资源及策略--包括标准化技术文件的写作、会议参与等示例

来分享自身学习及实做的绿色数字标准及创新，并介绍在哪做、怎么做、如何交付等实践知识。
...
# 3.3 交付：<i class="fa fa-briefcase text_success"></i> 绿色数字行动工具箱
...
国际电联ITU绿色化数字行动@COP28 已绘出时间流程图，我们将其中译如下：[简体中文]({{< ref "/Green_Digital_Action_at_COP28.zh-hans.pdf" >}})、[正／繁体中文]({{< ref "/Green_Digital_Action_at_COP28.zh-hant.pdf" >}})
